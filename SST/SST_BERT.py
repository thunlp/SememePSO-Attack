...
from SST2data.SSTconfig import filenames, parameters
import os
...
if __name__ == "__main__":
    ...
    label2id = json.load(open("SST2data/" + filenames.label2id, 'r', encoding='utf-8'))
    random.seed(parameters.random_seed)
    torch.manual_seed(parameters.random_seed)
    torch.cuda.manual_seed(parameters.random_seed)
    logger.info("Parameters:\n",str(parameters))
    train_ids = json.load(open("SST2data/"+filenames.train_set, 'r', encoding='utf-8'))
    valid_ids = json.load(open("SST2data/"+filenames.valid_set, 'r', encoding='utf-8'))
    test_ids = json.load(open("SST2data/"+filenames.test_set, 'r', encoding='utf-8'))
    id2content = json.load(open("SST2data/"+filenames.id2content, 'r', encoding='utf-8'))
